...
if (signupParams.has('error')) {
  ...
  switch (signupParams.get('error')) {
    ...
    case 'invalidchars': txt = '❌ Caractères non autorisés dans le pseudo'; break;
    case 'pwdlength': txt = '❌ Mot de passe trop long (20 char max)'; break;
    case 'captcha': txt = '❌ Captcha invalide.'; break;
...
async function loadCaptcha() {
  try {
    ...
    captchaQuestionEl.textContent = 'Captcha indisponible';
  }
}
